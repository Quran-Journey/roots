...
async function getVerseRootWords(data) {
  ...
  let sql =
    "SELECT * FROM (SELECT ayahID, aw.wordID, word, rootid FROM TextToWord as ttw JOIN ArabicWord as aw on aw.WordID=ttw.WordID WHERE AyahID=$1) as taw JOIN RootWords as rt ON rt.RootID=taw.rootID;";
